        ...
        <div className="py-12 max-w-[1200px] mx-auto">
            <div className="grid grid-cols-2 gap-10 items-center">
                ...
                <div className="space-y-3">
                    <motion.h2 initial={{filter: 'blur(10px)'}} animate={{filter: 'blur(0px)'}} transition={{duration: 0.3, delay: 0.3}} className={`font-medium text-5xl leading-snug ${k2d.className}`}>Professional Video Editor</motion.h2>
                    <motion.p initial={{filter: 'blur(10px)'}} animate={{filter: 'blur(0px)'}} transition={{duration: 0.3, delay: 0.5}} className="text-xl font-medium text-gray-600 leading-normal">I am a skilled video editor specializing in crafting compelling short videos, documentary films, and a wide range of other video content. With a keen eye for detail and a passion for storytelling, I transform raw footage into engaging and polished final products. My expertise includes: Combining technical proficiency with creative vision, I strive to deliver high-quality videos that resonate with audiences and achieve desired outcomes. Let{"'"}s collaborate to bring your vision to the screen!</motion.p>
                    <motion.h3 initial={{filter: 'blur(10px)'}} animate={{filter: 'blur(0px)'}} transition={{duration: 0.3, delay: 0.7}} className={`text-2xl font-medium ${k2d.className}`}>My Expertise</motion.h3>
                    <div>
                        <div className="mt-5 flex gap-6 items-center flex-wrap">
